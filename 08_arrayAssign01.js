...
console.log(`Step 1==> The length of given array : ${totalElements}`);
...
console.log(`Step 3==> The last third element is: ${arrayNumbers[lastThird]}`);
...
for (const index in arrayNumbers) {
   if(arrayNumbers[index] %2==0){  
        console.log(`Step 4 ==> The even numbers are : ${arrayNumbers[index]}`);
   } 
...
for (const index in arrayNumbers) {
    if(arrayNumbers[index] %2!=0){
         console.log(`Step 5 ==> The odd numbers are : ${arrayNumbers[index]}`);
    }
 }
...
console.log(`Step 7 ==> The sum of odd positioned elements are: ${sum1}`);
...
console.log(`Step 8==> The sum of all elements are: ${sum1}`);

console.log(`-----------------------------------------------`);

for (let index = 0; index < arrayNumbers.length; index++) {
    if (arrayNumbers[index] %5==0) {
        console.log(`Step 9==> The multiple of 5 is:${arrayNumbers[index]}`);
    }
